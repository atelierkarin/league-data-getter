...
class GoalnoteLeagueHtmlReader:
  ...
  def do(self):
    ...
    self.home_team_full_list = self.get_full_list(home_team_appearance, home_team_goals)
    self.away_team_full_list = self.get_full_list(away_team_appearance, away_team_goals)